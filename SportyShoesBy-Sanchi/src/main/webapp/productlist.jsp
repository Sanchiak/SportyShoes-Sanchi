...
<div class="header">
  <h1> Sporty Shoes Sanchi</h1>
   <div style="margin-left: 800px;"><form action="/logout" method="post">
  <input type="submit" value="Logout" style="background-color:sky blue ; ;height:50px; width:100px;">
  </form></div>
</div>
...
<div class="row">
  <div class="col-3 menu">
    <ul>
      <li><a href="/productlist">Show All Items</a></li>
      

      
      <li><b>View items by Brand</b></li>
  ...
  <div class="col-9">
    <h1>Sporty Shoe List<a href="exporttoPDF" style="margin-left: 150px;">Export to PDF</a></h1>
    <p>
